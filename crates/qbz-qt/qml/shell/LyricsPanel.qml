...
// (QbzPlayer.npElapsedSecs; the Slint engine ticks ~30 Hz and can fill
...
Rectangle {
    ...
    readonly property var doc: JSON.parse(QbzShell.lyricsJson)
    ...
    readonly property int activeIndex: {
        if (!synced) return -1
        var nowMs = (QbzPlayer.npElapsedSecs || 0) * 1000
        var idx = -1
    ...
    Column {
        ...
        Item {
            ...
            Column {
                ...
                Text {
                    visible: QbzPlayer.npTitle !== ""
                    width: parent.width
                    text: QbzPlayer.npTitle + " - " + QbzPlayer.npArtist
                    ...
                    Repeater {
                        ...
                        delegate: Text {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    if (modelData.timeMs !== null && QbzPlayer.npDurationSecs > 0)
                                        QbzPlayer.seek(modelData.timeMs / 1000 / QbzPlayer.npDurationSecs)
                                }
                            }
                        }
                    }
