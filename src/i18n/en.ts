export const en = {
  ...
  screenshots: {
    ...
    lead: 'The native Slint interface of QBZ 2.0, built for long listening sessions.',
    items: [
      {
        title: 'Discover and For You',
        text: 'Personalized rows blending Qobuz editorial with your own listening.',
      },
      {
        title: 'Playlist manager',
        text: 'Build, reorder, and manage playlists across Qobuz and local sources.',
      },
      {
        title: 'Playlist view',
        text: 'Track lists with artwork, quality badges, and one-click playback.',
      },
      {
        title: 'Immersive spectrum',
        text: 'Full-screen visualizers with lyrics and ambient backgrounds.',
      },
      {
        title: 'Local library',
      ...
      {
        title: 'Artist view',
        text: 'Discography, credits, and related artists in one place.',
      },
    ],
  },
  launchVideo: {
    title: 'QBZ 2.0 in motion',
    lead: 'A quick look at the native Slint interface in action.',
  },
  capabilities: {
  ...
  downloads: {
    ...
    macos: {
      experimental: 'macOS',
      disclaimer: 'Recommended: install independently signed and notarized builds. They are made from the upstream application without recompiling it; its signature and DMG are replaced by @afonsojramos. They are not produced or endorsed by the upstream QBZ project.',
      limitations: 'PipeWire, ALSA, and JACK are Linux-specific; macOS plays through CoreAudio, including a Core Audio Direct passthrough path for bit-perfect output.',
      credit: 'macOS port maintained by',
      signedVersion: 'Latest signed build: {{version}}',
      signedVersionUnknown: 'Latest available signed build (version shown on GitHub)',
      homebrewTitle: 'Install with Homebrew',
      ...
      upstreamNote: 'Prefer the official upstream artifacts if you do not want to trust the independent signing mirror. These DMGs are ad-hoc signed and require a one-time Gatekeeper override.',
